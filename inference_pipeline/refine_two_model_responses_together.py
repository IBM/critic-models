...
class RefineGen(InferenceBase):
    INITIAL_RESPONSES_PATH_KEY = "refined_two_responses"

    def __init__(self, model, base_model_for_lora, data_path, refine_prompt, another_data_path):
        super().__init__(model, base_model_for_lora, data_path)
        self.refine_prompt = refine_prompt
        self.other_data_path = another_data_path
        self.other_data = self.load_data(another_data_path)
